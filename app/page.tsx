    ...
    <main dir="rtl" className="min-h-screen bg-[#F5F7FA] text-[#17263d]">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#102f47] via-[#123c59] to-[#18b6b4] text-white">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 text-center md:py-36">
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            ...
            <Link href="/leave-details" className="inline-flex rounded-full border border-white/40 bg-white/10 px-8 py-4 font-bold text-white backdrop-blur-sm transition hover:bg-white/20">השאירו פרטים</Link>
          </div>
        </div>
      </section>
      ...
      <section id="sports" className="scroll-mt-28 px-6 py-24">
        <div className="mx-auto max-w-7xl">
          <div className="text-center">
            ...
            <p className="mx-auto mt-5 max-w-2xl leading-8 text-slate-500">העמותה פועלת לקידום מגוון ענפי ספורט וליצירת הזדמנויות לילדים, בני נוער וספורטאים מכל רחבי אשקלון.</p>
          </div>
      ...
      <section id="about" className="scroll-mt-28 bg-[#102f47] px-6 py-24 text-white">
        <div className="mx-auto max-w-6xl text-center">
          ...
          <p className="mx-auto mt-7 max-w-3xl text-lg leading-9 text-slate-300">העמותה לקידום הספורט באשקלון פועלת כדי להנגיש את עולם הספורט לתושבי העיר, לקדם ספורטאים ומועדונים וליצור קהילה ספורטיבית חזקה, מקצועית ומגוונת.</p>
        </div>
      </section>
      ...
      <section id="contact" className="scroll-mt-28 px-6 py-24">
        <div className="mx-auto max-w-4xl rounded-[2rem] bg-white p-10 text-center shadow-xl md:p-16">
          ...
          <Link href="/leave-details" className="mt-8 inline-flex rounded-full bg-[#18b6b4] px-8 py-4 font-bold text-white transition hover:bg-[#129da0]">השאירו פרטים</Link>
        </div>
      </section>
