    ...
    <main dir="rtl" className="min-h-screen bg-[#f5f7fa] text-[#17263d]">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#102f47] via-[#123c59] to-[#18b6b4]">
        ...
        <div className="relative mx-auto max-w-6xl px-6 py-20 text-center md:py-28">
          <div className="mb-5 inline-flex items-center rounded-full border border-[#6de3df]/40 bg-white/10 px-5 py-2 text-sm font-bold text-[#6de3df]">השאירו פרטים</div>
          <h1 className="text-4xl font-black leading-tight text-white md:text-6xl">מעוניינים להצטרף?</h1>
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-slate-200 md:text-xl">השאירו לנו את הפרטים שלכם ונחזור אליכם<br />עם כל המידע על החוג המתאים לכם.</p>
        </div>
      </section>
      ...
      <footer className="bg-[#0b2234] px-6 py-10 text-center text-white">
        <div className="text-xl font-black">העמותה לקידום<br />הספורט באשקלון</div>
