          ...
          <div className="rounded-[32px] bg-white p-7 shadow-xl ring-1 ring-slate-100 md:p-10">
            {!submitted ? (
              <>
                ...
                >
                  ...
                  <div>
                    <label
                      htmlFor="name"
                      className="mb-2 block text-sm font-bold text-[#102f47]"
                    >
                      שם מלא
                    </label>
                  ...
                  <button
                    type="submit"
                    className="w-full rounded-full bg-[#18b6b4] px-8 py-4 text-lg font-black text-white shadow-lg transition hover:-translate-y-1 hover:bg-[#129da0] hover:shadow-xl"
                  >
                    השאירו פרטים ונחזור אליכם
                  </button>

                  <p className="text-center text-xs leading-6 text-slate-400">
                    הפרטים ישמשו לצורך חזרה אליכם בנוגע לפעילות הספורטיבית
                    שבחרתם.
                  </p>
                </form>
              </>
              ...
              <div className="py-12 text-center">
                ...
                <h2 className="mt-7 text-3xl font-black text-[#102f47]">
                  תודה רבה!
                </h2>
