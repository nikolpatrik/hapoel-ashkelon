...
const coaches = [
  ...
  {
    name: "ניקול פטריק",
    role: "מאמנת סייף ומנהלת מועדון הסייף אשקלון",
    image: null,
    text: "מאמנת סייף ומנהלת מועדון הסייף אשקלון. מדריכת סיוף ושופטת סיוף בינלאומית, בעלת תעודת מאמני סיוף מווינגייט וניסיון בניהול, הדרכה, הובלת צוותים וקבלת החלטות בזמן אמת.",
  },
];
