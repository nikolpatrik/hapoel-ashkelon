...
const chapters = [
  ...
  ["המאה ה־19", "מועדונים, חוקים ותחרויות", "הסייף התרחק עוד יותר מהדו־קרב המעשי. מועדונים ואיגודים לאומיים צמחו, ציוד המגן השתפר, ותחרויות קיבלו כללים ברורים יותר. הענף החל להתפתח כמסורת של ספורט תחרותי בינלאומי ולא רק כמקצוע של אנשי צבא ואצולה."],
...
export default function FencingHistoryBook() {
  ...
  const go = (direction: "next" | "prev") => {
    ...
    setTurn(direction);
    window.setTimeout(() => { setPage(target); setTurn(null); }, 820);
  };
  ...
  return (
    <main dir="rtl" className="page">
      ...
      <style jsx>{`
        .page{min-height:100vh;background:#0d151a;color:#20272b;font-family:Arial,'Helvetica Neue',sans-serif}.hero{padding:72px 24px 55px;text-align:center;color:#fff;background:radial-gradient(circle at 50% 10%,#304a57,#0d151a 68%);font-family:Arial,'Helvetica Neue',sans-serif}.back{display:inline-block;color:#cbd8dd;text-decoration:none;font-weight:700;margin-bottom:30px}.eyebrow{font-size:11px;letter-spacing:4px;color:#8ea8b5;font-weight:800;margin-bottom:18px}.hero h1{font-size:clamp(48px,7vw,86px);line-height:.96;letter-spacing:-3px;margin:0}.hero h1 span{color:#19bbb7}.hero p{max-width:650px;margin:22px auto 0;color:#c4d0d5;font-size:17px;line-height:1.8}
        .library{padding:70px 18px 95px;background:radial-gradient(circle at 50% 35%,#2b4049 0,#10191f 52%,#080d11 100%);min-height:750px}.book{width:min(1160px,100%);height:650px;margin:auto;position:relative;filter:drop-shadow(0 38px 35px #000c);perspective:2200px}.book:before{content:"";position:absolute;inset:-13px;border-radius:6px;background:linear-gradient(145deg,#211107,#704a2b 45%,#190b04);box-shadow:inset 0 0 0 4px #8b6037,inset 0 0 0 7px #291307}.cover-edge{position:absolute;inset:0 50% 0 0;background:linear-gradient(90deg,#241208,#4a2c18,#1b0c05);border-radius:4px 0 0 4px;z-index:0}.spread{position:absolute;inset:8px;display:grid;grid-template-columns:1fr 1fr;transform-style:preserve-3d;overflow:hidden;background:#d8ccb8}.paper{position:relative;overflow:hidden;padding:64px 70px 48px;background:linear-gradient(100deg,#e8ddca,#faf5e9 22%,#f2e8d6);box-shadow:inset 0 0 30px #6b5b451c;line-height:2}.paper:before{content:"";position:absolute;inset:0;background:repeating-linear-gradient(0deg,transparent 0 31px,#8c7c6518 32px);pointer-events:none}.right-paper{grid-column:2;border-right:1px solid #c8baa2}.left-paper{grid-column:1;border-left:1px solid #c8baa2}.chapter-label{position:relative;z-index:1;font-family:Arial,'Helvetica Neue',sans-serif;font-size:10px;letter-spacing:1.5px;color:#9a784e;font-weight:800;margin-bottom:18px}.ornament{position:relative;z-index:1;font-size:27px;color:#b18a59;margin-bottom:8px}.paper h2,.paper h3{position:relative;z-index:1;color:#202a2e;line-height:1.18;margin:0 0 20px;font-weight:700}.paper h2{font-size:40px}.paper h3{font-size:30px;margin-top:90px}.paper p{position:relative;z-index:1;color:#505552;font-size:17px;line-height:1.95;margin:0}.rule,.mini-rule{position:relative;z-index:1;width:90px;height:2px;background:#b58a55;margin-bottom:23px}.mini-rule{width:65px}.date{position:absolute;z-index:1;bottom:74px;left:70px;font:12px Arial,'Helvetica Neue',sans-serif;color:#a17e51;letter-spacing:1px}.folio{position:absolute;bottom:18px;color:#9a8c78;font:12px Arial,'Helvetica Neue',sans-serif}.right-paper .folio{right:34px}.left-paper .folio{left:34px}.gutter{position:absolute;z-index:12;left:50%;top:0;bottom:0;width:24px;transform:translateX(-50%);background:linear-gradient(90deg,#a6967d,#f7edda 35%,#8e806b 65%,#dfd1b9);box-shadow:0 0 18px #0005;pointer-events:none}.click-zone{position:absolute;z-index:20;top:0;bottom:0;width:9%;background:transparent;border:0;cursor:pointer}.click-zone:hover{background:#ffffff08}.left-zone{left:0}.right-zone{right:0}
        .page-turn{position:absolute;z-index:15;inset:0 50% 0 0;transform-origin:right center;transform-style:preserve-3d;pointer-events:none;opacity:0;filter:drop-shadow(8px 0 12px #0005)}.is-next .page-turn{animation:turnNext .82s cubic-bezier(.22,.75,.2,1)}.is-prev .page-turn{left:50%;right:0;transform-origin:left center;animation:turnPrev .82s cubic-bezier(.22,.75,.2,1)}.turn-front,.turn-back{position:absolute;inset:0;background:linear-gradient(100deg,#e6dac7,#fff9ec 48%,#e8dcc9);backface-visibility:hidden;box-shadow:inset -18px 0 25px #6d5b4320,0 0 25px #0004}.turn-back{transform:rotateY(180deg);background:linear-gradient(260deg,#e2d5c0,#faf2e2 55%,#ddd0ba);box-shadow:inset 18px 0 25px #6d5b4320}.is-next .page-turn,.is-prev .page-turn{opacity:1}@keyframes turnNext{0%{transform:rotateY(0deg);box-shadow:0 0 0 #0000}45%{box-shadow:18px 0 24px #0006}100%{transform:rotateY(-180deg);box-shadow:0 0 0 #0000}}@keyframes turnPrev{0%{transform:rotateY(0deg);box-shadow:0 0 0 #0000}45%{box-shadow:-18px 0 24px #0006}100%{transform:rotateY(180deg);box-shadow:0 0 0 #0000}}
        .controls{display:flex;align-items:center;justify-content:center;gap:30px;margin-top:38px;font-family:Arial,'Helvetica Neue',sans-serif}.controls button{border:1px solid #61747c;background:#18272e;color:#fff;padding:13px 26px;border-radius:4px;font-weight:800;cursor:pointer;min-width:120px;transition:transform .25s ease,background .25s ease}.controls button:hover:not(:disabled){background:#24404b;transform:translateY(-2px)}.controls button:disabled{opacity:.3;cursor:not-allowed}.counter{color:#c4d0d4;min-width:70px;text-align:center}.counter strong{font-size:22px;color:#fff}.hint{text-align:center;color:#71838c;font:12px Arial,'Helvetica Neue',sans-serif;margin-top:15px}
